    ...
    <div>
      ...
      <section id="events" className="container-page py-12 sm:py-16">
        ...
        {grid.loading ? (
          ...
          <StatePanel
            title={tab === 'upcoming' ? 'Ближайшая тренировка запланирована' : 'Здесь пусто'}
            description={
              tab === 'upcoming'
                ? 'Данные по дистанции, треку и группам появятся позже — организаторы добавляют их ближе к дате.'
      ...
      <div className="container-page relative grid gap-10 py-16 sm:py-20 lg:grid-cols-[1.1fr_1fr] lg:items-center">
        <div className="min-w-0 animate-fade-up">
          ...
          <p className="mt-5 max-w-lg text-base leading-relaxed text-paper/70">
            🏃 Беговое сообщество Чебоксар без формальностей и вступительных взносов — выбери
            подходящую группу, приходи, беги вместе с другими участниками в заданном темпе и следи
            за прогрессом. Группы под любой уровень, разнообразные маршруты, финишные протоколы
